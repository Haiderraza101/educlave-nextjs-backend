  ...
  return (
    <div>
      {assignmentmarksform && (
        <div className="mt-6">
          <div
            onClick={() => setshowassignmenttable(!showassignmenttable)}
            className="flex items-center justify-between text-gray-700 bg-gray-200 px-5 py-3 rounded-t-lg cursor-pointer hover:bg-gray-300 transition"
          >
                      ...
                      <tr key={index} className="text-sm hover:bg-gray-50">
                        ...
                        <td className="py-2 px-4 border-t">
                          <input
                            ...
                            placeholder="8"
                            value={
                              assignmentmarksdata[index]?.obtainedmarks || ""
                            }
                            onChange={(e) =>
                              handleInputChange(
                                index,
                        ...
                        <td className="py-2 px-4 border-t">
                          <input
                            ...
                            className="w-16 px-2 py-1 border rounded-md text-center"
                            placeholder="10"
                            value={assignmentmarksdata[index]?.totalmarks || ""}
                            onChange={(e) =>
                              handleInputChange(
                                index,
                                "totalmarks",
