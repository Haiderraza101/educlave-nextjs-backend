...
export default function Sidebar() {
  ...
  const sidebarLinks = [
    { name: "Dashboard", href: `/TeacherHome/${TeacherId}`, icon: <FiBook /> },
    { name: "Courses", href: `/TeacherCourses/${TeacherId}`, icon: <FiBook /> },
    {
      name: "Attendance",
      href: `/TeacherAttendance/${TeacherId}`,
      icon: <FiUserCheck />,
    },
    {
      name: "Marks",
      href: `/TeacherMarks/${TeacherId}`,
      icon: <FiClipboard />,
    },
    {
      name: "Grades",
      href: `/UploadGrades/${TeacherId}`,
      icon: <FiFileText />,
    },
  ];
